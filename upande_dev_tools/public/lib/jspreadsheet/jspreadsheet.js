										...
										(o = function (e) {
											...
											var l,
												...
												m = (function () {
													var e = 0.636619772,
														r = [
															...
															-11214424.18, 77392.33017,
															-184.9052456,
														].reverse(),
														l = [
															57568490411, 1029532985, 9494680.718,
															59272.64853, 267.8532712, 1,
														].reverse(),
														i = [
														...
														s = [
															-0.01562499995, 0.0001430488765,
															-6911147651e-15, 7.621095161e-7,
															-9.34935152e-8,
														].reverse();
													function a(n) {
														var a = 0,
													...
													var u = [
														...
														f = [
															1, 0.00183105, -3516396496e-14,
															2457520174e-15, -2.40337019e-7,
														].reverse(),
														d = [
															0.04687499995, -0.0002002690873,
															8449199096e-15, -8.8228987e-7,
															1.05787412e-7,
														].reverse();
													function p(n) {
														var r = 0,
												...
												v =
													((l = 0.636619772),
													(i = [
														-2957821389, 7062834065, -512359803.6,
														10879881.29, -86327.92757, 228.4622733,
													].reverse()),
													(s = [
														40076544269, 745249964.8, 7189466.438,
														47447.2647, 226.1030244, 1,
													].reverse()),
													(a = [
														1, -0.001098628627, 2734510407e-14,
														-2073370639e-15, 2.093887211e-7,
													...
													(f = [
														249958057e5, 424441966400, 3733650367,
														22459040.02, 102042.605, 354.9632885, 1,
													].reverse()),
													(d = [
														1, 0.00183105, -3516396496e-14,
														2457520174e-15, -2.40337019e-7,
												...
												y =
													((b = [
														1, 3.5156229, 3.0899424, 1.2067492,
													...
													(h = [
														...
														0.02658733, 0.00301532, 32411e-8,
													].reverse()),
													(g = [
												...
												C = (function () {
													var e = [
															-0.57721566, 0.4227842, 0.23069756,
															0.0348859, 0.00262698, 1075e-7, 74e-7,
														].reverse(),
														n = [
														...
														l = [
															1, 0.15443144, -0.67278579,
															-0.18156897, -0.01919402, -0.00110404,
															-4686e-8,
														].reverse(),
														i = [
															1.25331414, 0.23498619, -0.0365562,
											...
											"undefined" == typeof DO_NOT_EXPORT_BESSEL
												? o(t)
												: o({});
									},
									162: function (e) {
										...
										e.exports =
											((t = (function (e, t) {
												...
												(u.fn = u.prototype),
													...
													(u.sliceAssign = function (o, n, r) {
														...
														if (a(n.row)) {
															if (a(n.col))
																return (o[n.row][n.col] = r);
															(n.col = n.col || {}),
																(n.col.start = n.col.start || 0),
																(n.col.end =
																	n.col.end || o[0].length),
												...
												(e.gammaln = function (e) {
													...
													(e.gammapinv = function (o, n) {
														var r,
															...
															d = e.gammaln(n);
														if (o >= 1)
															return t.max(100, n + 100 * t.sqrt(n));
														if (o <= 0) return 0;
														for (
															n > 1
																? ((a = t.log(f)),
													...
													(e.erf = function (e) {
														var o,
															...
															i = [
																...
																-20278578112534e-18,
																-1624290004647e-18,
																130365583558e-17, 1.5626441722e-8,
																-8.5238095915e-8, 6.529054439e-9,
																5.059343495e-9, -9.91364156e-10,
																-2.27365122e-10, 96467911e-18,
																2394038e-18, -6886027e-18,
																894487e-18, 313092e-18,
																-112708e-18, 381e-18, 7106e-18,
																-1523e-18, -94e-18, 121e-18,
																-28e-18,
															],
															s = i.length - 1,
															a = !1,
												...
												function n(o, n, r) {
													...
													for (
														...
														for (
															...
															var w =
																2 *
																	e.normal.cdf(C, 0, 1, 1, 0) *
																	0.5 -
																2 *
																	e.normal.cdf(C, o, 1, 1, 0) *
																	0.5;
															w >= t.exp(-30 / b) &&
																(h += w =
																	i[y - 1] *
													...
													e.extend(e.arcsine, {
														...
														cdf: function (e, o, n) {
															return e < o
																...
																: e < n
																? (2 / t.PI) *
																  t.asin(t.sqrt((e - o) / (n - o)))
																: 1;
														},
														inv: function (e, o, n) {
															return (
																o +
																(0.5 - 0.5 * t.cos(t.PI * e)) *
																	(n - o)
															);
														},
														mean: function (e, t) {
											...
											t.extend({
												...
												builddxmatrix: function () {
													for (
														var e = new Array(arguments[0].length),
															o = 0;
												...
												regresst: function (e, o, n) {
													...
													(l.anova.residuals = t.residuals(o, i)),
														...
														(l.anova.mst =
															l.anova.sst / (o.length - 1)),
														(l.anova.r2 =
															1 - l.anova.sse / l.anova.sst),
														l.anova.r2 < 0 && (l.anova.r2 = 0),
														(l.anova.fratio =
															l.anova.msr / l.anova.mse),
													...
													for (
														...
														(a = Math.sqrt(
															l.anova.mse * Math.abs(f[d][d])
														)),
															(u = Math.abs(r[d] / a)),
															(c = t.ttest(
																u,
																o.length - e[0].length - 1,
																n
															)),
															(l.stats[d] = [r[d], a, u, c]);
											...
											return (
												...
												(u.getRangeFromTokens = function (e) {
													...
													return (
														e.sort(function (e, t) {
															var o =
																	Helpers.getCoordsFromColumnName(
																		e
																	),
																n =
																	Helpers.getCoordsFromColumnName(
												...
												(u.getTokensFromRange = function (e) {
													...
													if (null === o[1] && null == n[1])
														for (
															...
															var f = u.getCoordsFromColumnName(
																a[c]
															);
															f[0] === o[0] &&
																(null === i || f[1] < i) &&
													...
													for (var d = [], p = i; p <= s; p++) {
														...
														for (c = r; c <= l; c++)
															b.push(
																t + u.getColumnNameFromCoords(c, p)
															);
														d.push(b);
													}
													return d;
									...
									592: function (e, t, o) {
										...
										const Ie = {
											...
											De = {
												EXC: (e, t) => {
													...
													switch (t) {
														case 1:
															return Ie.EXC(e, 0.25);
														case 2:
															return Ie.EXC(e, 0.5);
														case 3:
															return Ie.EXC(e, 0.75);
														default:
															return c;
													}
												},
												INC: (e, t) => {
													...
													switch (t) {
														case 1:
															return Ie.INC(e, 0.25);
														case 2:
															return Ie.INC(e, 0.5);
														case 3:
															return Ie.INC(e, 0.75);
														default:
															return c;
													}
												},
										...
										function Nt(e) {
											...
											return (
												(n = "i" === n || "j" === n ? n : "i"),
												xt(
													(Math.cos(t) * (Math.exp(o) + Math.exp(-o))) /
														2,
													(-Math.sin(t) * (Math.exp(o) - Math.exp(-o))) /
														2,
													n
												)
											);
										...
										function St(e) {
											...
											return (
												(n = "i" === n || "j" === n ? n : "i"),
												xt(
													(Math.cos(o) * (Math.exp(t) + Math.exp(-t))) /
														2,
													(Math.sin(o) * (Math.exp(t) - Math.exp(-t))) /
														2,
													n
												)
											);
										...
										(t.ABS = function (e) {
											...
											(t.AVEDEV = function () {
												...
												return t instanceof Error
													? t
													: n.sum(n(t).subtract(n.mean(t)).abs()[0]) /
															t.length;
											}),
											(t.AVERAGE = te),
											(t.AVERAGEA = oe),
											...
											(t.BASE = function (e, t, o) {
												...
												return (
													new Array(Math.max(o + 1 - r.length, 0)).join(
														"0"
													) + r
												);
											}),
											(t.BESSELI = function (e, t) {
												return M((e = F(e)), (t = F(t)))
													? s
													: r.besseli(e, t);
											}),
											...
											(t.GROWTH = function (e, t, o, n) {
												...
												let r;
												if (void 0 === t)
													for (t = [], r = 1; r <= e.length; r++)
														t.push(r);
												if (void 0 === o)
													for (o = [], r = 1; r <= e.length; r++)
														o.push(r);
											...
											(t.LOGEST = function (e, t) {
												...
												return (
													(o[0] =
														Math.round(1e6 * Math.exp(o[0])) / 1e6),
													(o[1] =
														Math.round(1e6 * Math.exp(o[1])) / 1e6),
													o
												);
											}),
											(t.LOGINV = ao),
											...
											(t.PDURATION = function (e, t, o) {
												return M((e = F(e)), (t = F(t)), (o = F(o)))
													? s
													: e <= 0
													? c
													: (Math.log(o) - Math.log(t)) /
													  Math.log(1 + e);
											}),
											(t.PEARSON = Me),
											(t.PERCENTILE = Ie),
											...
											(t.XNPV = function (e, t, o) {
												if (M((e = F(e)), (t = L(v(t))), (o = T(v(o)))))
													return s;
												let n = 0;
												for (let r = 0; r < t.length; r++)
													n +=
														t[r] /
														Math.pow(1 + e, rt(o[r], o[0]) / 365);
												return n;
											}),
											(t.XOR = function () {
												const e = v(arguments);
					...
					(factory = function () {
						...
						var Version =
							...
							jexcel = function (el, options) {
								...
								if (!(el instanceof Element || el instanceof HTMLDocument))
									return (
										console.error(
											"Jspreadsheet: el is not a valid DOM element"
										),
										!1
									);
								if ("TABLE" == el.tagName) {
								...
								(obj.el = el),
										...
										for (var o = [], n = 0; n < e; n++)
											obj.options.colHeaders[n] ||
												...
												obj.options.columns[n].width ||
													(obj.options.columns[n].width = obj.options
														.colWidths[n]
														? obj.options.colWidths[n]
														: obj.options.defaultColWidth),
									...
									(obj.createTable = function () {
										...
										if (
											...
											(obj.paginationDropdown =
												...
												(obj.paginationDropdown.onchange = function () {
													(obj.options.pagination = parseInt(
														this.value
													)),
														obj.page(0);
												});
											for (
												...
												(r.value = obj.options.paginationOptions[n]),
													(r.innerHTML =
														obj.options.paginationOptions[n]),
													obj.paginationDropdown.appendChild(r);
											}
											(obj.paginationDropdown.value =
										...
										if (
											...
											var p = Object.keys(obj.options.classes);
											for (n = 0; n < p.length; n++) {
												var b = jexcel.getIdFromColumnName(p[n], !0);
												obj.records[b[1]][b[0]].classList.add(
													obj.options.classes[p[n]]
												);
											}
										}
									}),
									...
									(obj.getData = function (e, t) {
										for (
											...
											for (var u = 0; u < i; u++)
												(e &&
													!obj.records[a][u].classList.contains(
														"highlight"
													)) ||
													(o[r] || (o[r] = []),
													(o[r][n] = l
									...
									(obj.getJson = function (e) {
										for (
											...
											for (var l = null, i = 0; i < o; i++)
												(e &&
													!obj.records[r][i].classList.contains(
														"highlight"
													)) ||
													(null == l && (l = {}),
									...
									(obj.createRow = function (e, t) {
										obj.records[e] || (obj.records[e] = []),
											t || (t = obj.options.data[e]),
								...
								(obj.createCell = function (e, t, o) {
									...
									if (obj.options.columns[e].editor)
										...
										!1 === obj.options.stripHTML ||
										!1 === obj.options.columns[e].stripHTML
											? (n.innerHTML = stripScript(
													obj.parseValue(e, t, o, n)
											  ))
									...
									(obj.createCellHeader = function (e) {
										...
										(obj.headers[e] = document.createElement("td")),
											obj.options.stripHTML
												? (obj.headers[e].textContent = obj.options
														.columns[e].title
														? obj.options.columns[e].title
														: jexcel.getColumnName(e))
												: (obj.headers[e].innerHTML = obj.options.columns[
														e
												  ].title
														? obj.options.columns[e].title
														: jexcel.getColumnName(e)),
										...
										for (var t = 0; t < e.length; t++)
											if ("i" == e[t].type)
												(l = document.createElement("i")).classList.add(
													...
													e[t].tooltip &&
														l.setAttribute("title", e[t].tooltip),
												...
												(l =
													document.createElement(
														"select"
													)).classList.add("jexcel_toolbar_item"),
													l.setAttribute("data-k", e[t].k),
													e[t].tooltip &&
														l.setAttribute("title", e[t].tooltip),
									...
									(obj.setMerge = function (e, t, o, n) {
										...
										if (!e) {
											if (!obj.highlighted.length)
												return (
													alert(obj.options.text.noCellsSelected), null
												);
											var l = parseInt(
											...
											(e = jexcel.getColumnNameFromId([l, i])),
												(t = s - l + 1),
												(o = a - i + 1);
										}
										...
										if (obj.options.mergeCells[e])
											...
											for (var c = u[1]; c < u[1] + o; c++)
												for (var f = u[0]; f < u[0] + t; f++)
													jexcel.getColumnNameFromId([f, c]),
														obj.records[c][f].getAttribute(
															"data-merged"
														) &&
															(r =
																obj.options.text
										...
										if (r) alert(r);
											...
											t > 1
												...
												(obj.records[u[1]][u[0]].style.overflow =
													"hidden");
									...
									(obj.removeMerge = function (e, t, o) {
										if (obj.options.mergeCells[e]) {
											...
											obj.records[n[1]][n[0]].removeAttribute("colspan"),
												...
												obj.records[n[1]][n[0]].removeAttribute(
													"data-merged"
												);
											for (
									...
									(obj.openEditor = function (e, t, o) {
										...
										if (1 == e.classList.contains("readonly"));
											...
											(i = obj.options.data[n][r]),
												...
												(obj.options.columns[r].options.onclose =
													function (t, o) {
														obj.closeEditor(e, !0);
													}),
												"color" == obj.options.columns[r].type
									...
									(obj.closeEditor = function (e, t) {
										...
										if (1 == t) {
											if (obj.options.columns[o].editor)
												var r = obj.options.columns[o].editor.closeEditor(
													e,
													t
												);
											else if (
												...
												"=" !=
													("" + (r = e.children[0].value)).substr(
														0,
														1
													) &&
													"" == r &&
													(r = obj.options.columns[o].allowEmpty
														? ""
														: 0),
									...
									(obj.getValue = function (e, t) {
										if ("object" == typeof e)
											...
											(o = (e = jexcel.getIdFromColumnName(e, !0))[0]),
												(n = e[1]);
										var r = null;
										return (
											null != o &&
										...
										if ("string" == typeof e) {
											...
											if (i.length > 0)
												for (var s = 0; s < i.length; s++) {
													var a;
													"string" == typeof e[s]
														? ((r = (a = jexcel.getIdFromColumnName(
																e[s],
																!0
														  ))[0]),
														  (l = a[1]))
														: null != e[s].x && null != e[s].y
														? ((r = e[s].x),
														  (l = e[s].y),
														  null != e[s].newValue
																? (t = e[s].newValue)
									...
									(obj.setCheckRadioValue = function () {
										for (
											...
											("checkbox" != obj.options.columns[n].type &&
												...
												e.push(
													obj.updateCell(n, r, !obj.options.data[r][n])
												);
										}
										e.length &&
											(obj.setHistory({
								...
								(obj.updateCell = function (e, t, o, n) {
									if (
										...
										"=" == ("" + o).substr(0, 1) &&
											...
											obj.options.columns[e].editor &&
												"function" ==
													typeof obj.options.columns[e].editor
														.updateCell &&
										...
										if (f)
											(obj.options.data[t][e] = o),
												"function" == typeof f.setValue &&
													f.setValue(obj.records[t][e], o);
										else if (
											"checkbox" == obj.options.columns[e].type ||
											"radio" == obj.options.columns[e].type
										) {
									...
									(obj.copyData = function (e, t) {
										...
										for (var d = 0, p = 0, b = l; b <= s; b++)
											if (
												!obj.rows[b] ||
												"none" != obj.rows[b].style.display
											) {
												null == o[p] && (p = 0),
													(d = 0),
													n[0] != r && (f = r < n[0] ? r - n[0] : 1);
												for (var j = r; j <= i; j++) {
													if (
														obj.records[b][j] &&
														!obj.records[b][j].classList.contains(
															"readonly"
														) &&
														"none" !=
															obj.records[b][j].style.display &&
														0 == u
													) {
														if (
														...
														if (
															h &&
															!o[1] &&
															1 == obj.options.autoIncrement
														)
															if (
																"text" ==
																	obj.options.columns[j].type ||
																"number" ==
																	obj.options.columns[j].type
															)
																if ("=" == ("" + h).substr(0, 1)) {
									...
									(obj.conditionalSelectionUpdate = function (e, t, o) {
										if (1 == e) {
											...
											obj.selectedCell &&
											((t >= obj.selectedCell[0] &&
												t <= obj.selectedCell[2]) ||
												(o >= obj.selectedCell[0] &&
													o <= obj.selectedCell[2]))
										)
											return void obj.resetSelection();
									}),
										...
										if (obj.highlighted.length) {
											...
											for (var t = 0; t < obj.highlighted.length; t++) {
												...
												if (obj.highlighted[t].getAttribute("data-merged"))
													var r = parseInt(
															obj.highlighted[t].getAttribute(
																"colspan"
															)
														),
														l = parseInt(
												...
												for (var a = o; a <= i; a++)
													obj.headers[a] &&
														obj.headers[a].classList.remove(
															"selected"
														);
												for (a = n; a <= s; a++)
													obj.rows[a] &&
									...
									(obj.updateSelectionFromCoords = function (e, t, o, n, r) {
										...
										if (
											...
											null == o && (o = e),
											null == n && (n = t),
											e >= obj.headers.length &&
												(e = obj.headers.length - 1),
											t >= obj.rows.length && (t = obj.rows.length - 1),
											o >= obj.headers.length &&
												(o = obj.headers.length - 1),
											...
											for (c = i; c <= s; c++) {
												for (f = a; f <= u; f++)
													"none" != obj.rows[f].style.display &&
														"none" !=
															obj.records[f][c].style.display &&
														(obj.records[f][c].classList.add(
															"highlight"
														),
											...
											for (h || (h = 0), g || (g = 0), c = h; c <= g; c++)
												"hidden" != obj.options.columns[c].type &&
													...
													(obj.records[m] &&
														obj.records[m][c] &&
														obj.records[m][c].classList.add(
															"highlight-top"
														),
													obj.records[v] &&
														obj.records[v][c] &&
														obj.records[v][c].classList.add(
															"highlight-bottom"
														),
											...
											for (f = m; f <= v; f++)
												obj.rows[f] &&
													"none" != obj.rows[f].style.display &&
													(obj.records[f][h].classList.add(
														"highlight-left"
													),
													obj.records[f][g].classList.add(
														"highlight-right"
													),
									...
									(obj.removeCopySelection = function () {
										for (var e = 0; e < obj.selection.length; e++)
											obj.selection[e].classList.remove("selection"),
												obj.selection[e].classList.remove(
													"selection-left"
												),
												obj.selection[e].classList.remove(
													"selection-right"
									...
									(obj.updateCopySelection = function (e, t) {
										...
										if (null != e && null != t) {
											...
											s - i <= u - a
												? ((i = parseInt(o)), (s = parseInt(r)))
												: ((a = parseInt(n)), (u = parseInt(l)));
											for (var c = a; c <= u; c++)
												for (var f = i; f <= s; f++)
													obj.records[c][f] &&
														"none" != obj.rows[c].style.display &&
														"none" !=
															obj.records[c][f].style.display &&
														(obj.records[c][f].classList.add(
															"selection"
														),
														obj.records[a][f].classList.add(
															"selection-top"
														),
														obj.records[u][f].classList.add(
															"selection-bottom"
														),
														obj.records[c][i].classList.add(
															"selection-left"
														),
														obj.records[c][s].classList.add(
															"selection-right"
														),
									...
									(obj.getWidth = function (e) {
										if (void 0 === e)
											...
											"object" == typeof e && (e = e.getAttribute("data-x")),
									...
									(obj.setHeight = function (e, t, o) {
										t > 0 &&
											...
											o ||
												(o = obj.rows[e].getAttribute("height")) ||
									...
									(obj.setFooter = function (e) {
										if (
											(e && (obj.options.footers = e), obj.options.footers)
										) {
											obj.tfoot ||
									...
									(obj.updateMeta = function (e) {
										if (obj.options.meta) {
											for (
												var t = {},
													o = Object.keys(obj.options.meta),
													n = 0;
												n < o.length;
												n++
											)
									...
									(obj.getComments = function (e, t) {
										if (e)
											return (
												...
												t
													? [
															obj.records[e[1]][e[0]].getAttribute(
																"title"
															),
															obj.records[e[1]][e[0]].getAttribute(
																"author"
										...
										for (var o = {}, n = 0; n < obj.options.data.length; n++)
											for (var r = 0; r < obj.options.columns.length; r++) {
												...
												l &&
													(o[(e = jexcel.getColumnNameFromId([r, n]))] =
														l);
											}
										return o;
									}),
									(obj.setComments = function (e, t, o) {
										...
										var r = obj.records[n[1]][n[0]].getAttribute("title"),
											l = [
												r,
												(o =
													obj.records[n[1]][n[0]].getAttribute(
														"data-author"
													)),
											];
									...
									(obj.orderBy = function (e, t) {
										if (e >= 0) {
											...
											t =
												null == t
													? obj.headers[e].classList.contains(
															"arrow-down"
													  )
														? 1
														: 0
									...
									(obj.insertRow = function (e, t, o) {
										if (1 == obj.options.allowInsertRow) {
											...
											if (
												((null == t || t >= parseInt(l) || t < 0) &&
													(t = l),
												!1 ===
													obj.dispatch("onbeforeinsertrow", el, t, r, o))
											)
												return !1;
											if (
										...
										if (1 == obj.options.allowDeleteRow)
											if (
												...
												if (null == e) {
													...
													o[0]
														? ((e = parseInt(
																o[0].getAttribute("data-y")
														  )),
														  (t = o.length))
														: ((e = obj.options.data.length - 1),
														  (t = 1));
												}
												...
												if (parseInt(e) > -1) {
													var r = !1;
													if (
														Object.keys(obj.options.mergeCells)
															.length > 0
													)
														for (var l = e; l < e + t; l++)
															obj.isRowMerged(l, !1).length &&
																(r = !0);
													if (r) {
														if (
															!confirm(
													...
													for (
														...
														Array.prototype.indexOf.call(
															...
															obj.rows[l].parentNode.removeChild(
																obj.rows[l]
															));
										...
										for (
											obj.options.columns.splice(
												...
												obj.headers.splice(
													t,
													0,
													obj.headers.splice(e, 1)[0]
												),
												obj.colgroup.splice(
													t,
													0,
													obj.colgroup.splice(e, 1)[0]
												),
												n = 0;
											n < obj.rows.length;
											n++
										...
										if (1 == obj.options.allowInsertColumn) {
											...
											for (var m = 0; m < obj.options.data.length; m++) {
												...
												for (b[m] = [], p[m] = [], h = a; h < l + a; h++) {
													...
													var x = obj.createCell(
														h,
														m,
														obj.options.data[m][h]
													);
													(obj.records[m][h] = x),
														obj.rows[m] &&
												...
												if (
													...
													for (
														...
														for (
															...
															A.push(h);
														obj.thead.children[g].children[
															obj.thead.children[g].children.length -
																1
													...
													(w =
														...
														obj.thead.children[0].children[
															obj.thead.children[0].children.length -
																1
														].setAttribute("colspan", w);
											obj.setHistory({
												action: "insertColumn",
											...
											if (obj.headers.length > 1) {
												...
												if (parseInt(e) > -1) {
													...
													if (obj.options.footers)
														for (
															d = 0;
															d < obj.options.footers.length;
															d++
														)
															f[d] = obj.options.footers[d].splice(
																e,
																t
															);
													if (
														...
														if (
															...
															for (
																var p = 0;
																p <
																obj.options.nestedHeaders.length;
																p++
															) {
																var b =
																	parseInt(
											...
											for (
												...
												for (n = 0; n < obj.headers.length; n++)
													obj.options.updateTable(
														...
														jexcel.getColumnNameFromId([n, t])
													);
											obj.options.detachForUpdates &&
									...
									if (obj.formula[n] && obj.formula[n].length > 0)
										if (chainLoopProtection[n])
											...
											for (var r = 0; r < obj.formula[n].length; r++) {
												var l = jexcel.getIdFromColumnName(
														obj.formula[n][r],
														!0
													),
								...
								(obj.executeFormula = function (expression, x, y) {
												...
												for (var i = 0; i < tokens.length; i++)
													if (
														(obj.formula[tokens[i]] ||
															(obj.formula[tokens[i]] = []),
														obj.formula[tokens[i]].indexOf(parentId) <
															0 &&
									...
									(obj.up = function (e, t) {
										if (
											...
											if (
												0 == obj.selectedCell[1] ||
												0 == obj.selectedCell[3]
											)
												obj.loadPage(0),
													obj.updateSelectionFromCoords(
														obj.selectedCell[0],
									...
									(obj.up.visible = function (e, t) {
										...
										0 == e
											? ((obj.selectedCell[0] = o),
											  (obj.selectedCell[1] = n))
											: ((obj.selectedCell[2] = o),
											  (obj.selectedCell[3] = n));
									}),
									...
									(obj.updateResult = function () {
										...
										for (var o = 0; o < obj.rows.length; o++)
											!obj.results || obj.results.indexOf(o) > -1
												? (t < e &&
														(obj.tbody.appendChild(obj.rows[o]), t++),
									...
									(obj.whichPage = function (e) {
										return (
											...
											Math.ceil(
												(parseInt(e) + 1) /
													parseInt(obj.options.pagination)
											) - 1
										);
									}),
									(obj.page = function (e) {
									...
									(obj.copy = function (e, t, o, n, r) {
										...
										for (
											...
											for (var w = 0; w < f; w++)
												(e &&
													!obj.records[x][w].classList.contains(
														"highlight"
													)) ||
													(v <= w && (v = w), y <= x && (y = x));
										if (
											...
											(r && 1 == obj.options.includeHeadersOnDownload) ||
												(!r &&
													1 == obj.options.includeHeadersOnCopy &&
													!C) ||
												n)
										) {
											if (
											...
											for (s = [], a = [], w = 0; w < f; w++)
												if (
													...
													if (
														...
														s.push(I),
														"checkbox" ==
															obj.options.columns[w].type ||
															"radio" == obj.options.columns[w].type)
													)
														var N = I;
													else
														(N =
															1 == obj.options.stripHTMLOnCopy
																? obj.records[x][w].textContent
																: obj.records[x][w].innerHTML)
															.match &&
															(N.match(l) ||
																N.match(/,/g) ||
																N.match(/\n/) ||
									...
									(obj.paste = function (e, t, o) {
										...
										if (
											(1 == obj.options.copyCompatibility &&
												...
												(o = obj.data),
											(o = obj.parseCSV(o, "\t")),
											(s > 1) & Number.isInteger(s / o[0].length))
										) {
											...
											for (
												...
												for (b = 0, y = parseInt(e); null != x[b]; ) {
													...
													if (
														...
														var A = jexcel.getColumnNameFromId([y, C]);
														(g[A] = f[v]),
															(m[A] = obj.getStyle(A)),
															obj.records[C][y].setAttribute(
																"style",
																f[v]
															),
															v++;
									...
									(obj.historyProcessColumn = function (e, t) {
										...
										if (1 == e) {
											...
											for (var r = o; r < n + o; r++)
												obj.headers[r].parentNode.removeChild(
													obj.headers[r]
												),
											...
											for (l = 0; l < t.data.length; l++)
												for (
													obj.options.data[l] = jexcel.injectArray(
														obj.options.data[l],
														o,
														t.data[l]
													),
														obj.records[l] = jexcel.injectArray(
															obj.records[l],
															o,
															t.records[l]
														),
											...
											if (obj.options.footers)
												for (l = 0; l < obj.options.footers.length; l++)
													obj.options.footers[l] = jexcel.injectArray(
										...
										if (
											...
											if (
												...
												for (
													l = 0;
													l < obj.options.nestedHeaders.length;
													l++
												) {
													if (1 == e)
														var s =
													...
													(obj.options.nestedHeaders[l][
														...
														obj.thead.children[l].children[
															obj.thead.children[l].children.length -
																1
									...
									(obj.redo = function () {
										...
										if (
											((obj.ignoreEvents = !0),
											(obj.ignoreHistory = !0),
											obj.historyIndex < obj.history.length - 1)
										) {
									...
									(obj.getDropDownValue = function (e, t) {
										...
										if (
											...
											for (
												var n = [],
													r = obj.options.columns[e].source,
													l = 0;
												l < r.length;
												l++
											)
									...
									options && null != options.contextMenu
										...
										: (obj.options.contextMenu = function (e, t, o, n) {
												...
												if (null == o)
													...
													r.push({ type: "line" });
													var l =
														obj.records[o][t].getAttribute("title") ||
														"";
													r.push({
														title: l
									...
									(obj.updateFreezePosition = function () {
										...
										if ((scrollLeft = obj.content.scrollLeft) > 50)
												...
												for (var o = 0; o < obj.rows.length; o++)
													if (obj.rows[o] && obj.records[o][t]) {
														var n =
															scrollLeft +
															(t > 0
																? obj.records[o][t - 1].style.width
																: 0) -
															51 +
															"px";
														obj.records[o][t].classList.add(
															"jexcel_freezed"
														),
											...
											for (t = 0; t < obj.options.freezeColumns; t++)
												for (
													obj.headers[t].classList.remove(
														"jexcel_freezed"
													),
								...
								for (var t = Object.keys(e), o = 0; o < t.length; o++)
									"function" == typeof e[t[o]] &&
										...
										jexcel.license &&
											...
											e[t[o]].license(jexcel.license));
							}),
							void 0 !== formula && (jexcel.formula = formula),
							(jexcel.version = Version),
							(jexcel.current = null),
							(jexcel.timeControl = null),
							(jexcel.timeControlLoading = null);
						const destroyEvents = function (e) {
							e.removeEventListener("mouseup", jexcel.mouseUpControls),
								e.removeEventListener("mousedown", jexcel.mouseDownControls),
								e.removeEventListener("mousemove", jexcel.mouseMoveControls),
								e.removeEventListener("mouseover", jexcel.mouseOverControls),
								e.removeEventListener("dblclick", jexcel.doubleClickControls),
								e.removeEventListener("paste", jexcel.pasteControls),
								e.removeEventListener("contextmenu", jexcel.contextMenuControls),
								e.removeEventListener("touchstart", jexcel.touchStartControls),
								e.removeEventListener("touchend", jexcel.touchEndControls),
								e.removeEventListener("touchcancel", jexcel.touchEndControls),
						...
						return (
							(jexcel.destroy = function (e, t) {
								if (e.jexcel) {
									...
									e.removeEventListener(
										...
										(e.jexcel = null),
										(e.innerHTML = ""),
										t && (destroyEvents(o), (jexcel = null));
								}
							}),
							(jexcel.build = function (e) {
								destroyEvents(e),
									e.addEventListener("mouseup", jexcel.mouseUpControls),
									e.addEventListener("mousedown", jexcel.mouseDownControls),
									e.addEventListener("mousemove", jexcel.mouseMoveControls),
									e.addEventListener("mouseover", jexcel.mouseOverControls),
									e.addEventListener("dblclick", jexcel.doubleClickControls),
									e.addEventListener("paste", jexcel.pasteControls),
									e.addEventListener("contextmenu", jexcel.contextMenuControls),
									e.addEventListener("touchstart", jexcel.touchStartControls),
									e.addEventListener("touchend", jexcel.touchEndControls),
									e.addEventListener("touchcancel", jexcel.touchEndControls),
									e.addEventListener("touchmove", jexcel.touchEndControls),
								...
								if (jexcel.current) {
									if (jexcel.current.edition)
										if (27 == e.which)
											...
											if (
												...
												(1 == jexcel.current.options.wordWrap ||
													1 ==
														jexcel.current.options.columns[
															jexcel.current.edition[2]
														].wordWrap ||
									...
									if (!jexcel.current.edition && jexcel.current.selectedCell)
										if (37 == e.which)
											...
											1 == jexcel.current.options.editable &&
												(jexcel.current.selectedRow
													? 1 == jexcel.current.options.allowDeleteRow &&
													  confirm(
											...
											e.shiftKey
												? jexcel.current.up()
												: (1 == jexcel.current.options.allowInsertRow &&
														1 ==
															jexcel.current.options
																.allowManualInsertRow &&
														jexcel.current.selectedCell[1] ==
															jexcel.current.options.data.length -
																1 &&
											...
											e.shiftKey
												? jexcel.current.left()
												: (1 == jexcel.current.options.allowInsertColumn &&
														1 ==
															jexcel.current.options
																.allowManualInsertColumn &&
														jexcel.current.selectedCell[0] ==
															jexcel.current.options.data[0].length -
																1 &&
											...
											if (
												...
												"readonly" !=
													jexcel.current.options.columns[l].type &&
													(32 == e.keyCode
														? (e.preventDefault(),
														  "checkbox" ==
																jexcel.current.options.columns[l]
																	.type ||
														  "radio" ==
																jexcel.current.options.columns[l]
																	.type
											...
											65 == e.which
												? (jexcel.current.selectAll(), e.preventDefault())
												: 83 == e.which
												? (jexcel.current.download(), e.preventDefault())
												: 89 == e.which
												? (jexcel.current.redo(), e.preventDefault())
												: 90 == e.which
												? (jexcel.current.undo(), e.preventDefault())
												: 67 == e.which
												? (jexcel.current.copy(!0), e.preventDefault())
												: 88 == e.which
												? (1 == jexcel.current.options.editable
														? jexcel.cutControls()
														: jexcel.copyControls(),
												  e.preventDefault())
												: 86 == e.which && jexcel.pasteControls();
									else
								...
								if (
									(o[0]
										...
										: jexcel.current &&
										  ...
										  jexcel.current.resetSelection(!0),
										  (jexcel.current = null)),
									jexcel.current && 1 == t)
								) {
											...
											if ((p = e.target.getAttribute("data-x"))) {
												...
												if (
													...
													(jexcel.current.resizing = {
														...
														jexcel.current.headers[p].classList.add(
															"resizing"
														);
													for (
														var r = 0;
														r < jexcel.current.records.length;
														r++
													)
														jexcel.current.records[r][p] &&
															jexcel.current.records[r][
																p
															].classList.add("resizing");
												} else if (
													1 == jexcel.current.options.columnDrag &&
													...
													if (
														...
														jexcel.current.selectedHeader == p &&
															1 ==
																jexcel.current.options
																	.allowRenameColumn &&
												...
												if (e.target.getAttribute("data-column"))
													...
													(a = 0),
														(u =
															jexcel.current.options.columns.length -
															1);
												jexcel.current.updateSelectionFromCoords(
													a,
													0,
										...
										if (2 == o[1]) {
											...
											if (e.target.classList.contains("jexcel_row"))
												(n = e.target.getBoundingClientRect()),
													1 == jexcel.current.options.rowResize &&
													n.height - e.offsetY < 6
														? ((jexcel.current.resizing = {
														...
														: 1 == jexcel.current.options.rowDrag &&
														  n.width - e.offsetX < 6
														? jexcel.current.isRowMerged(c).length
															? console.error(
																	"Jspreadsheet: This row is part of a merged cell"
															  )
															: 1 == jexcel.current.options.search &&
												...
												if (d) {
													...
													(c = d[1]),
														jexcel.current.edition &&
															((jexcel.current.edition[2] == p &&
																jexcel.current.edition[3] == c) ||
																jexcel.current.closeEditor(
																	jexcel.current.edition[0],
																	!0
																)),
							...
							(jexcel.mouseUpControls = function (e) {
								if (jexcel.current)
									if (jexcel.current.resizing) {
										...
										if (jexcel.current.dragging) {
											if (jexcel.current.dragging.column) {
												...
												for (r = 0; r < jexcel.current.headers.length; r++)
													jexcel.current.headers[r].classList.remove(
														"dragging-left"
													),
														jexcel.current.headers[r].classList.remove(
															"dragging-right"
										...
										jexcel.current.selectedCorner &&
											((jexcel.current.selectedCorner = !1),
											jexcel.current.selection.length > 0 &&
									...
									if (1 == jexcel.isMouseAction) {
										if (jexcel.current.resizing)
											if (jexcel.current.resizing.column) {
												var o =
													e.pageX -
													jexcel.current.resizing.mousePosition;
											...
											if (jexcel.current.dragging.column) {
												...
												if (i)
													if (jexcel.current.isColMerged(i).length)
														console.error(
															"Jspreadsheet: This column is part of a merged cell."
														);
													else {
														for (
															var s = 0;
															s < jexcel.current.headers.length;
															s++
														)
															jexcel.current.headers[
																s
														...
														jexcel.current.dragging.column == i
															? (jexcel.current.dragging.destination =
																	parseInt(i))
													...
													if (jexcel.current.isRowMerged(a).length)
														...
														var u =
															e.target.clientHeight / 2 > e.offsetY
																...
																: e.target.parentNode;
														jexcel.current.dragging.element != u &&
							...
							(jexcel.mouseOverControls = function (e) {
								...
								if (
									(t || (jexcel.isMouseAction = !1),
									jexcel.current && 1 == jexcel.isMouseAction)
								) {
									var o = jexcel.getElement(e.target);
									if (o[0]) {
										...
										if (jexcel.current.resizing || jexcel.current.dragging);
											...
											2 == o[1] &&
												(e.target.classList.contains("jexcel_row")
													? jexcel.current.selectedRow &&
													  ((l = jexcel.current.selectedRow),
													  (i = r),
													  jexcel.current.updateSelectionFromCoords(
															0,
															l,
								...
								if (jexcel.current)
									if (e.target.classList.contains("jexcel_corner")) {
										if (jexcel.current.highlighted.length > 0) {
											var t =
													jexcel.current.highlighted[0].getAttribute(
														"data-x"
													),
												o =
													parseInt(
											...
											jexcel.current.copyData(
												jexcel.current.records[o][t],
												jexcel.current.records[r][n]
											);
										}
									} else if (
										...
										if (
											(1 == i[1] &&
												1 == jexcel.current.options.columnSorting &&
												(l = e.target.getAttribute("data-x")) &&
												jexcel.current.orderBy(l),
											2 == i[1] &&
												1 == jexcel.current.options.editable &&
												!jexcel.current.edition)
										) {
											...
											a &&
												...
												jexcel.current.openEditor(a);
										}
									}
							}),
							(jexcel.copyControls = function (e) {
								jexcel.current &&
									jexcel.copyControls.enabled &&
									(jexcel.current.edition || jexcel.current.copy(!0));
							}),
							(jexcel.cutControls = function (e) {
								jexcel.current &&
									(jexcel.current.edition ||
										(jexcel.current.copy(!0),
										1 == jexcel.current.options.editable &&
											jexcel.current.setValue(
												jexcel.current.highlighted,
												""
							...
							(jexcel.contextMenuControls = function (e) {
								if (
									...
									if (jexcel.current.edition) e.preventDefault();
										...
										if (t || o) {
											(t < parseInt(jexcel.current.selectedCell[0]) ||
												t > parseInt(jexcel.current.selectedCell[2]) ||
												o < parseInt(jexcel.current.selectedCell[1]) ||
												o > parseInt(jexcel.current.selectedCell[3])) &&
												jexcel.current.updateSelectionFromCoords(
													t,
													o,
													t,
											...
											var n = jexcel.current.options.contextMenu(
												jexcel.current,
												t,
												o,
												e
											);
											jexcel.current.contextMenu.contextmenu.open(e, n),
												e.preventDefault();
										}
									}
							}),
							(jexcel.touchStartControls = function (e) {
								...
								if (
									(t[0]
										? jexcel.current != t[0].jexcel &&
										  (jexcel.current && jexcel.current.resetSelection(),
										  (jexcel.current = t[0].jexcel))
										: jexcel.current &&
										  (jexcel.current.resetSelection(),
										  (jexcel.current = null)),
									jexcel.current && !jexcel.current.edition)
								) {
									var o = e.target.getAttribute("data-x"),
										n = e.target.getAttribute("data-y");
									o &&
										n &&
										(jexcel.current.updateSelectionFromCoords(o, n),
										(jexcel.timeControl = setTimeout(function () {
											"color" == jexcel.current.options.columns[o].type
												? (jexcel.tmpElement = null)
												: (jexcel.tmpElement = e.target),
												jexcel.current.openEditor(e.target, !1, e);
										}, 500)));
								}
							}),
							(jexcel.touchEndControls = function (e) {
								jexcel.timeControl &&
									...
									(jexcel.timeControl = null),
									jexcel.tmpElement &&
										"INPUT" == jexcel.tmpElement.children[0].tagName &&
										...
										: (o.setRequestHeader("Accept-Charset", "x-user-defined"),
										  (o.onreadystatechange = function () {
												if (4 == o.readyState && 200 == o.status) {
													var e = convertResponseBodyToText(
															o.responseBody
														),
														r = XLSX.read(e, {
															type: "binary",
							...
							(jexcel.getColumnNameFromId = function (e) {
								return (
									...
									jexcel.getColumnName(parseInt(e[0])) + (parseInt(e[1]) + 1)
								);
							}),
							...
							(jexcel.createFromTable = function (e, t) {
								if ("TABLE" == e.tagName) {
										...
										for (var a = 0; a < s.length - 1; a++) {
											...
											for (n = 0; n < s[a].children.length; n++) {
												var c = {
													...
													colspan:
														s[a].children[n].getAttribute("colspan") ||
														1,
												};
												u.push(c);
											}
									...
									for (a = 0; a < h.length; a++)
										if (
											((t.data[f] = []),
											1 != t.parseTableFirstRowAsHeader ||
												s.length ||
												0 != a)
										) {
											for (n = 0; n < h[a].children.length; n++) {
												...
												x && (b[m] = x),
													h[a].children[n].classList.contains(
														"styleBold"
													) &&
														(b[m]
							...
							(jexcel.helpers =
								((component = {
									...
									getColumnNameFromCoords: function (e, t) {
										return (
											component.getColumnName(parseInt(e)) +
											(parseInt(t) + 1)
										);
									},
								...
								(function (e) {
									e.fn.jspreadsheet = e.fn.jexcel = function (t) {
										...
										return o.jexcel
											...
											: jexcel(e(this).get(0), arguments[0]);
									};
								})(jQuery),
							jexcel
						);
