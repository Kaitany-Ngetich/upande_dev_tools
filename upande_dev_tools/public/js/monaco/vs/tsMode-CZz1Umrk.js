							...
							createWorker: () =>
								new Worker(
									new URL(
										"" +
											new URL(
												require.toUrl("./assets/ts.worker-CMbG-7ft.js"),
												document.baseURI
											).href,
...
`
		...
		_convertRelatedInformation(e, t) {
			...
			return (
				t.forEach((n) => {
					let l = e;
					if ((n.file && (l = this._libFiles.getOrCreateModel(n.file.fileName)), !l))
						return;
					const d = n.start || 0,
						a = n.length || 1,
...
`,
	...
	function $(g, e) {
		...
		function d() {
			...
			Z(t),
				a.completionItems &&
					t.push(i.languages.registerCompletionItemProvider(e, new C(n))),
				...
				a.documentHighlights &&
					t.push(i.languages.registerDocumentHighlightProvider(e, new H(n))),
				...
				a.documentSymbols &&
					t.push(i.languages.registerDocumentSymbolProvider(e, new W(n))),
