...
`)
			...
			do {
				...
				V === q || (V < w && c[V - 1] < c[V + 1])
					...
					: ((f = c[V - 1] + 1),
					  ...
					  (y = V - 1 - e)),
					D >= 0 &&
						((c = this.m_forwardHistory[D]), (e = c[0]), (q = 1), (w = c.length - 1));
			} while (--D >= -1);
	...
	const Vt = class Vt {
		...
		valueSetReplace(e, n, r) {
			let s = e.indexOf(n);
			return s >= 0
				? ((s += r ? 1 : -1), s < 0 ? (s = e.length - 1) : (s %= e.length), e[s])
				: null;
		}
	};
	Vt.INSTANCE = new Vt();
	...
	(function (t) {
		...
		function n(i) {
			...
			return (
				l ||
					(console.info("No codicon found for SymbolKind " + i), (l = M.symbolProperty)),
				l
			);
		}
		t.toIcon = n;
		...
		function s(i) {
			...
			return (
				l === void 0 &&
					(console.info("No completion kind found for SymbolKind " + i), (l = 20)),
				l
			);
		}
...
` ||
	...
	const et = class et {
		...
		findLastMaxBy(e) {
			let n,
				r = !0;
			return (
				this.iterate((s) => ((r || wn.isGreaterThan(e(s, n))) && ((r = !1), (n = s)), !0)),
				n
			);
		}
	};
	...
	class de {
		...
		subtractFrom(e) {
			...
			return (
				i < e.endLineNumberExclusive && s.push(new $(i, e.endLineNumberExclusive)),
				new de(s)
			);
		}
		toString() {
...
`);
	...
	class ys {
		compute(e, n, r = ct.instance) {
			...
			const s = e,
				i = n;
			function l(d, x) {
				for (; d < s.length && x < i.length && s.getElement(d) === i.getElement(x); )
					d++, x++;
				return d;
			}
			let o = 0;
	...
	class Ft {
		...
		findSubWordContaining(e) {
			...
			let r = e;
			for (; r < this.elements.length && Oe(this.elements[r]) && !Ls(this.elements[r]); )
				r++;
			return new B(n, r);
		}
		countLinesIn(e) {
...
`).length >= 15 && Ya(f, (p) => p.length >= 2) >= 2
	...
	function Es(t, e, n, r, s = !1) {
		...
		function u(h, f) {
			...
			for (; i.length > 0; ) {
				const v = i[0];
				if (!(v.seq1Range.intersects(b.seq1Range) || v.seq2Range.intersects(b.seq2Range)))
					break;
...
`);
	...
	const z = class z {
		...
		lighten(e) {
			return new z(
				new oe(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * e, this.hsla.a)
			);
		}
		darken(e) {
			return new z(
		...
		opposite() {
			return new z(
				new g(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a)
			);
		}
		mix(e, n = 0.5) {
	...
	(function (t) {
		(function (e) {
			(function (n) {
				...
				function i(d) {
					return d.hsla.a === 1
						? `hsl(${d.hsla.h}, ${Math.round(d.hsla.s * 100)}%, ${Math.round(
								d.hsla.l * 100
						  )}%)`
				...
				n.formatHSL = i;
				function l(d) {
					return `hsla(${d.hsla.h}, ${Math.round(d.hsla.s * 100)}%, ${Math.round(
						d.hsla.l * 100
					)}%, ${d.hsla.a.toFixed(2)})`;
				}
				n.formatHSLA = l;
				...
				function c(d, x = !1) {
					return x && d.rgba.a === 1
						...
						: `#${o(d.rgba.r)}${o(d.rgba.g)}${o(d.rgba.b)}${o(
								Math.round(d.rgba.a * 255)
						  )}`;
				}
				n.formatHexA = c;
				function h(d) {
