#!/bin/bash
# Provisions a bench, installs ERPNext and Upande Dev Tools onto a fresh test
...
bench get-app upande_dev_tools "${GITHUB_WORKSPACE}"
...
bench --verbose --site test_site install-app upande_dev_tools
